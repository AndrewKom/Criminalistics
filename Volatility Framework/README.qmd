...
Из интересного можно отметить только процесс с pid=740, WanaDecryptor, который был вызван pid=1940, explorer.exe. Остальные представляют на первый взгляд базовые процессы системы Windows.
...
Отправляем файл на проверку в VirusTotal и подтверждаем свои опасения. Это вредоносная программа, WannaCry — вредоносная программа, сетевой червь и программа-вымогатель денежных средств, поражающая компьютеры под управлением операционной системы Microsoft Windows.
